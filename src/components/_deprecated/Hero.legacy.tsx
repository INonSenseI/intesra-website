// ⚠️ NEPOUŽÍVANÝ SOUBOR — DEPRECATED
// Toto je starší verze Hero sekce, nahrazená souborem src/components/Hero.tsx
// (ten teď navíc čte texty a ikony z src/content/hero.txt a texty.txt).
// Nikde v aplikaci se neimportuje. Ponecháno pouze pro referenci, klidně smazat.

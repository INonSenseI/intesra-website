...
export function PhoneIcon({ size = 18, className = "", strokeWidth = 2.5 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function MagnifierIcon({ size = 24, className = "" }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
// --- Ikony pro Hero (typy zakázek) ---

export function WaterIcon({ size = 36, className = "" }: IconProps) {
  return (
...
export function BathroomIcon({ size = 20, className = "" }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export function HeatingIcon({ size = 20, className = "" }: IconProps) {
  return <GasIcon size={size} className={className} />;
}

export function PipeIcon({ size = 20, className = "" }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
